...
<body>
	...
	<form action="add" method="POST">
		...
		<input type="hidden" id="idCliente" name="idCliente" value="${autor.idAutor}" />
		<br>
		Nombre
		...
		<button onclick="window.location.href='/ismac-libreria-nocturno-web//findAll'; return false;">Cancelar</button>
